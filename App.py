...
with tab_carte:
    ...
    st.info("💡 **Bascule de cartes :** Utilisez le menu en haut à droite sur la carte pour basculer entre la carte marine NOAA (chiffres de profondeur), le relief bathymétrique ESRI et le sa[...]")
    ...
    def generer_carte(lat, lon, zoom):
        ...
        # 5. Carte Historique 1961 (si disponible)
        # Si tu as une URL de tuiles historiques, remplace <URL_1961> par l'URL des tuiles.
        # Exemple (placeholder) : 'https://historical-tiles.example.com/1961/{z}/{x}/{y}.png'
        folium.TileLayer(
            tiles='https://historical-tiles.example.com/1961/{z}/{x}/{y}.png',
            attr='Carte Historique 1961',
            name='Carte Historique 1961',
            overlay=False,
            max_zoom=16
        ).add_to(m)
